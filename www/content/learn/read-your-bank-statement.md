---
title: How to read your bank statement properly
slug: read-your-bank-statement
section: learn
group: Start here
order: 3
description: What every column on a bank statement actually means, why the descriptions are so unhelpful, and the checks that catch a misread statement before it corrupts months of numbers.
summary: Bank statements are written for banks, not for you. Once you know what the columns mean, why one shop appears under six names, and how to check a statement reconciles, the rest of personal finance gets considerably easier.
